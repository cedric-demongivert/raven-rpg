export type RPGImageFormat = number

export namespace RPGImageFormat {
  /**
  *
  */
  export type SVG = 0
  ...
  *
  */
  export const ALL: RPGImageFormat[] = [
    SVG
  ]
  ...
  *
  */
  export function fromExtension(path: string): RPGImageFormat {
  ...
  *
  */
  export function fromString(extension: string): RPGImageFormat {
  ...
  *
  */
  export function toString(type: RPGImageFormat): string | undefined {
    switch (type) {
      case SVG: return 'SVG'
  ...
  *
  */
  export function toDebugString(type: RPGImageFormat): string {
