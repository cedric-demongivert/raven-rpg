...
export namespace CorvusCharacteristicCommand {
  ...
  *
  */
  export function* reduceContent(classes: Iterable<string> = Empty.ARRAY): UnidocReducer<CorvusCharacteristic.ElementBuilder> {
    const result: CorvusCharacteristic.ElementBuilder = CorvusCharacteristic.createElementBuilder()
  ...
  *
  */
  export function* reduceTag(additionalClasses: Iterable<string> = Empty.ARRAY): UnidocReducer<CorvusCharacteristic.ElementBuilder> {
    yield* UnidocReducer.skipStart()
    yield* UnidocReducer.skipWhitespaces()
