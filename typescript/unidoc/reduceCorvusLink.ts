...
import { CorvusLinkBuilder } from "../model"
 ...
 *
 */
export function* reduceCorvusLink(): UnidocReduction<CorvusLinkBuilder> {
  yield* UnidocReducer.assertStart()
  yield UnidocReduction.NEXT

  const builder: CorvusLinkBuilder = new CorvusLinkBuilder()
