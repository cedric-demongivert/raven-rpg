...
export namespace Task {
  ...
  *
  */
  export function create<Properties extends Task.Properties>(properties: Properties): Task<Properties> {
  ...
  */
  ...
  export function pending<Type extends number = number>(type: Type): PendingTask<Type> {
    return create({ type, state: TaskState.PENDING, result: undefined, reason: undefined })
  }
}
