...
export function Xemeter () : ReactElement {
  return (
    <Subject>
      <SubjectIdentifier>magic-runes-stars-xemeter</SubjectIdentifier>
      <SubjectKeyword>rune</SubjectKeyword>
      <SubjectTitle>Xèmétèr</SubjectTitle>
      <SubjectSummary>
      </SubjectSummary>
      <SubjectContent>
        ...
        <p className='text-center'>
          Xèmétèr, l'horloger, est la rune permettant de parler du temps, et
